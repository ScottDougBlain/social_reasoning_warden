...
from src.profiles import TargetProfile, assign_profiles_to_seats, generate_profile
...
def main():
    ...
    profile_schedule: list[TargetProfile] | None = None
