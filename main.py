...
TRAIN_SCENARIOS = {
    ...
    "ai_moratorium": AIMoratoriumScenario,
    ...
    "chicken": ChickenScenario,
    "coding_agent": CodingAgentScenario,
    "compartmentalized_review": CompartmentalizedReviewScenario,
    ...
    "safety_coalition": SafetyCoalitionScenario,
    "scaling_decision": ScalingDecisionScenario,
    "stag_hunt": StagHuntScenario,
